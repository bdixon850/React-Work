...
var databaseUrl = process.env.MONGODB_URI || "mongodb://<bdixon850>:<senior07>@ds233167.mlab.com:33167/heroku_1crlnct1";
...
app.get("*", function(req, res) {
	res.sendFile(path.join(__dirname, "./review/public/index.html"));
});
